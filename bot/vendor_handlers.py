...
async def _prompt_vendor_categories(message: Message, state: FSMContext) -> None:
    ...
    await message.answer(
        "<b>Шаг 7 — категории товаров</b>\n\n"
        "Напишите одну категорию товаров.\n\n"
        "<b>Примеры:</b>\n"
        ...
        "Карго\n"
        "Байер\n\n"
        "После каждой категории я спрошу:\n"
        "добавить ещё или продолжить дальше.\n\n"
        f"Можно добавить до {MAX_VENDOR_CATEGORIES} категорий.\n\n"
        "👇 <b>Напишите первую категорию одним сообщением.</b>",
