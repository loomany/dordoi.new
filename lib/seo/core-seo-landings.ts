...
const CORE_LANDINGS: CoreSeoLanding[] = [
  {
    ...
    introByLocale: {
      ru: "Рынок Дордой — крупнейший оптовый торговый комплекс Бишкека, куда приезжают покупатели из Кыргызстана, Казахстана, Узбекистана, Таджикистана и других стран. Dordoi.help помогает сориентироваться в поставщиках, категориях и сервисах закупки без хаотичного обхода всех рядов.",
      kk: "Дордой нарығы — Бішкектің ірі көтерме сауда кешені. Dordoi.help жеткізушілер мен санаттар бойынша бағдар беруге көмектеседі.",
      kg: "Дордой базары — Бишкектин ири опт соода комплекси. Dordoi.help жеткирүүчүлөр жана категориялар боюнча багыт берет.",
      uz: "Dordoy bozori — Bishkekdagi yirik ulgurji savdo majmuasi. Dordoi.help yetkazib beruvchilar va toifalar bo'yicha yo'l ko'rsatadi.",
      tj: "Бозори Дордой — маҷмуи бузурги савдои оптӣ дар Бишкек. Dordoi.help дар бораи таъминкунандагон ва категорияҳо кӯмак мекунад.",
    },
    bodyByLocale: {
      ru: "На этой странице собрана обзорная информация о рынке Дордой: как искать поставщиков по категориям, зачем нужен каталог Dordoi.help и когда имеет смысл подключать байера. Сервис не заменяет личный осмотр товара, но ускоряет первичный поиск и помогает открыть профиль продавца с запросом контакта через защищённый поток.",
      kk: "Бұл бетте Дордой нарығы туралы шолу бар: жеткізушілерді қалай іздеуге және Dordoi.help каталогын қалай пайдалануға болады.",
      kg: "Бул баракта Дордой базары жөнүндө обзор бар: жеткирүүчүлөрдү кантип издөө жана Dordoi.help каталогун кантип колдонуу керек.",
      uz: "Ushbu sahifada Dordoy bozori haqida umumiy ma'lumot: yetkazib beruvchilarni qanday qidirish va Dordoi.help katalogidan qanday foydalanish.",
      tj: "Дар ин саҳифа маълумоти умумӣ дар бораи бозори Дордой: чӣ тавр таъминкунандаро ҷустуҷӯ кардан мумкин аст.",
    },
    faqByLocale: {
      ru: [
        {
  ...
  },
  {
    ...
    introByLocale: {
      ru: "Оптовая закупка на рынке Дордой начинается с выбора категории и поставщика. Dordoi.help собирает профили продавцов, помогает сравнить ассортимент и запросить контакт без публикации прямых телефонов в открытом HTML.",
      kk: "Дордой нарығында көтерме сатып алу санат пен жеткізушіні таңдаудан басталады.",
      kg: "Дордой базарында опт сатып алуу категория жана жеткирүүчүнү тандоодон башталат.",
      uz: "Dordoy bozorida ulgurji xarid toifa va yetkazib beruvchini tanlashdan boshlanadi.",
      tj: "Хариди оптӣ дар бозори Дордой аз интихоби категория ва таъминкунанда оғоз мешавад.",
    },
    bodyByLocale: {
      ru: "Используйте каталог и SEO-страницы категорий, чтобы быстрее найти продавцов одежды, обуви, текстиля и других направлений. Условия минимальной партии, образцы и отгрузка уточняются в профиле поставщика. При необходимости подключайте байера для проверки товара на месте.",
      kk: "Сатушыларды тезірек табу үшін каталог пен санат беттерін пайдаланыңыз.",
      kg: "Сатуучуларды тезирээк табуу үчүн каталогду жана категория барактарын колдонуңуз.",
      uz: "Sotuvchilarni tezroq topish uchun katalog va toifa sahifalaridan foydalaning.",
      tj: "Барои ёфтани зудтари фурӯшандагон аз каталог ва саҳифаҳои категория истифода баред.",
    },
    faqByLocale: {
      ru: [
  ...
  },
  {
    ...
    introByLocale: {
      ru: "Dordoi.help не является собственной карго-компанией, но помогает покупателям найти байера, поставщика и контакт для организации доставки товаров с рынка Дордой. Условия, сроки и стоимость зависят от направления и выбранного логистического партнёра.",
      kk: "Dordoi.help жеке карго компаниясы емес, бірақ жеткізуді ұйымдастыру үшін контакт табуға көмектеседі.",
      kg: "Dordoi.help өзүнчө карго компаниясы эмес, бирок жеткирүүнү уюштуруу үчүн байланыш табууга жардам берет.",
      uz: "Dordoi.help mustaqil kargo kompaniyasi emas, lekin yetkazib berishni tashkil qilish uchun kontakt topishga yordam beradi.",
      tj: "Dordoi.help ширкати мустақили карго нест, аммо барои ташкили интиқол тамос ёфтан кӯмак мекунад.",
    },
    bodyByLocale: {
      ru: "Типичный сценарий: вы находите поставщика в каталоге, согласовываете партию, затем обсуждаете доставку с байером или логистом. Детали маршрута, упаковки и таможенных нюансов уточняются индивидуально. Используйте каталог и раздел байеров как стартовую точку, а не как гарантию фиксированного тарифа карго.",
      kk: "Жеткізу шарттары бағытқа байланысты және жеке келісіледі.",
      kg: "Жеткирүү шарттары багытка көз карандуу жана жеке макулдашылат.",
      uz: "Yetkazib berish shartlari yo'nalishga bog'liq va alohida kelishiladi.",
      tj: "Шартҳои интиқол ба самт вобастаанд ва алоҳида мувофиқ карда мешаванд.",
    },
    faqByLocale: {
      ru: [
