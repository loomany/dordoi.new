...
function buildSystemInstructions(): string {
  return [
    ...
    "- Сайт **сам** обрезает хвосты «Бренд, магазин/бутик/…» до запятой — для таких `storeTitle` **всегда верни null**.",
    "- **Обязательно** заполни catalogBrandName, если весь `storeTitle` — **чистая заглушка** без бренда: «Магазин женской одежды», «Бутик женской одежды», «Магазин», «123» и т.п.",
    "- Для заглушек используй смысл из текста и **обязательно** подсказку из пути `instagramProfileUrl` (если передан): короткое человекочитаемое имя 1–4 слова, **без** точного ника, @, URL.",
    "- Не повторяй дословно Instagram-handle, не включай @, URL, «instagram», суффиксы _kg, _official.",
    ...
    "- Если честно вывести нельзя — null (сайт попробует Instagram сам).",
    "",
    "Поле subtitle:",
    "- Одна строка **другого угла**, чем catalogBrandName и storeTitle: география, ниша ассортимента, формат («Производство в Бишкеке»), но **не** повтор общей формулы «магазин …» / «оптовый магазин …», если бренд уже в названии.",
