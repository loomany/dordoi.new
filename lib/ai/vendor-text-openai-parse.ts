...
function buildSystemInstructions(): string {
  return [
    ...
    "",
    "Поле description:",
    "- Одна лаконичная продающая выжимка по сути бизнеса и ассортимента, без «воды», без обращений «звоните/пишите», без контактов.",
    `- Не длиннее ${DESCRIPTION_CARD_MAX_CHARS} символов.`,
