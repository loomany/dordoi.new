...
**Дата:** 2026-05-12T18:44:47.076Z
**limit:** 100 | **include-ratings:** false

## Параметры прогона

- **discovery-group:** `trade-market`
- **include-text-search:** true
- **grid:** `compact` (5 точек: центр + N,S,E,W)
- **radii (м):** 500, 700
- **output-tag:** `discovery-trade-market-compact-500-700` (автоматически: `discovery-{discovery-group}-{grid}-{radii}`)

## Выходные файлы (этот прогон)

- `data/generated/dordoi-google-places.discovery-trade-market-compact-500-700.raw.json`
- `data/generated/dordoi-google-places.discovery-trade-market-compact-500-700.catalog-matched.json`
- `data/generated/dordoi-google-places.discovery-trade-market-compact-500-700.discovery-unmapped.json`
- `data/generated/dordoi-google-places.discovery-trade-market-compact-500-700.excluded.json`
- `data/generated/dordoi-google-places.discovery-trade-market-compact-500-700.discovery-summary.csv`
- `reports/dordoi-google-places-discovery-trade-market-compact-500-700-summary.md`
